...
if __name__ == "__main__":
    ...
    image_path = "certidao_nascimento.jpeg"  # Replace with the path to your image
    document_type = "Certidão de Nascimento"  # Document type: RG, CPF, Certidão de Casamento, etc.
